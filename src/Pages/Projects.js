          ...
          >
            ...
            <a href="https://stickmansaga.com/" className="item">
              <div className="item__data">
                ...
                <div>
                  PvP P2E battle arena, battle and compete to win $STIX and
            ...
            <a href="https://www.jazzheroes.io/" className="item">
              <div className="item__data">
                ...
                <div>
                  The first ever player’s initiative NFT collection that
                  illustrates Utah Jazz players as superheroes. By the players
                  for the Community!
                </div>
              </div>
            </a>
            ...
            <a href="https://www.graveyarddao.com/" className="item">
              <div className="item__data">
                ...
                <div>
                  The Graveyard DAO is a community of NFT collectors who are
                  tired of holding onto dead NFT collections.
                </div>
              </div>
            </a>
            <a href="https://discord.gg/notion" className="item">
              <div className="item__data">
                ...
                <div>
                  This community-run Discord server is all about Notion, the
